...
static const float m_fVertices[8][3] = {
    {   -0.5,     1.5,    -0.5 },    // 0 front top left
    {    0.5,     1.5,    -0.5 },    // 1 front top right
    {    0.5,    -1.5,    -0.5 },    // 2 front bottom right
    {   -0.5,    -1.5,    -0.5 },    // 3 front bottom left
    {   -0.5,     1.5,     0.5 },    // 4 rear top left
    {    0.5,     1.5,     0.5 },    // 5 rear top right
    {    0.5,    -1.5,     0.5 },    // 6 rear bottom right
    {   -0.5,    -1.5,     0.5 }     // 7 rear bottom left
};
